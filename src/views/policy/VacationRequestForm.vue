        ...
        <el-card shadow="never">
          ...
          <el-form label-position="top" :model="form">
            ...
            <el-form-item label="휴가 유형">
              <el-select v-model="form.vacationType" placeholder="휴가 유형을 선택하세요" style="width: 100%;">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="휴가 시작일">
                  <el-date-picker v-model="form.startDate" type="date" value-format="YYYY-MM-DD" style="width: 100%;" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="휴가 종료일">
                  <el-date-picker v-model="form.endDate" type="date" value-format="YYYY-MM-DD" style="width: 100%;" />
                </el-form-item>
              </el-col>
            </el-row>

            <el-form-item label="휴가 기간 (일)">
              <el-input-number v-model="form.duration" :min="0.5" :step="0.5" style="width: 100%;" />
            </el-form-item>

            <el-form-item label="휴가 사유">
              <el-input 
                v-model="form.reason" 
                type="textarea" 
                :rows="4"
                placeholder="휴가 사유를 구체적으로 입력해주세요."
              />
            </el-form-item>

            <el-form-item label="비상 연락처">
              <el-input v-model="form.emergencyContact" placeholder="비상 시 연락 가능한 번호" />
            </el-form-item>
...
onMounted(() => {
  ...
  if (route.query.vacationType) {
    form.value.vacationType = route.query.vacationType;
  }
});
